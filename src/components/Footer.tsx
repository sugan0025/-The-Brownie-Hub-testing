        ...
        <div className="footer-grid">
          <div className="footer-col">
            ...
            <div style={{ marginTop: '20px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              ...
              <a
                href="https://wa.me/919500415490"
                target="_blank"
                rel="noopener noreferrer"
                className="social-pill-whatsapp magnetic-btn"
                aria-label="WhatsApp +91 95004 15490"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              <li><a href="#menu">Signature Classic Brownie</a></li>
              <li><a href="#menu">Double Chocolate Brownie</a></li>
              <li><a href="#menu">Pack of 4 Classic Brownies</a></li>
              <li><a href="#menu">Pack of 4 Double Chocolate</a></li>
            </ul>
          </div>
