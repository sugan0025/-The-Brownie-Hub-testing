    ...
    <>
      <nav id="main-nav" className="navbar">
        <div className="nav-container">
          ...
          <ul className="nav-links">
            ...
            <li><a href="/#bestsellers" className="nav-link" data-nav="bestsellers">Bestsellers</a></li>
            <li><a href="/#builder" className="nav-link" data-nav="builder">Custom Box</a></li>
            <li><a href="/#menu" className="nav-link" data-nav="menu">Menu</a></li>
      ...
      <div className="mobile-menu-overlay" id="mobile-menu-overlay">
        <ul className="mobile-nav-links">
          ...
          <li><a href="/#bestsellers" className="mobile-nav-link">Bestsellers</a></li>
          <li><a href="/#builder" className="mobile-nav-link">Custom Box</a></li>
          <li><a href="/#menu" className="mobile-nav-link">Menu</a></li>
