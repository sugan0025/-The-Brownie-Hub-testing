...
export const INDIVIDUAL_BROWNIES: BrownieItem[] = [
  {
    ...
    description: 'Dense, gooey, dark-chocolate base with a glossy crinkle surface — freshly baked with farm-fresh eggs, rich, and indulgent for every chocolate lover.',
    price: 69,
    dietary: 'nonveg',
    badge: 'Bestseller',
    isPopular: true,
    image: '/images/brownies/classic-fudge.jpg',
    ingredients: '70% Belgian Couverture, French Butter, Pure Dutch Cocoa, Farm Fresh Eggs',
  ...
  },
  {
    ...
    description: 'Extra rich and intensely fudgy, crafted with farm-fresh eggs and loaded with double chocolate couverture chunks for an explosion of pure chocolate in every bite.',
    price: 99,
    dietary: 'nonveg',
    badge: 'Chocoholic Favorite',
    isPopular: true,
    image: '/images/brownies/double-chocolate.jpg',
    ingredients: '70% Belgian Dark Chunks, Dark Cocoa Liquor, Pure Butter, Farm Fresh Eggs, Vanilla Extract',
...
export const CURATED_BOXES: CuratedBox[] = [
  {
    ...
    includes: ['4x Signature Classic Brownie (Contains Egg)'],
  },
  {
    ...
    includes: ['4x Double Chocolate Brownie (Contains Egg)'],
  },
